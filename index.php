...
<body >
	...
	<div id="header">
       <br>
       <h1 class="head1" style=" font-family:Agency FB; font-size: 70px; color:red;text-shadow: 2px 2px black;"> Sparks Foundation Internship Project </h1>
       <h2 class="head2" style=" font-family:Agency FB; font-size: 55px;color:#ee10ee;text-shadow: 2px 2px black; margin-top: 0;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Basic Banking System </h2>
    </div>
        <div id="section">
            <table>
                <tr></tr>
    ...
    <h3>The GRIP Internship Program</h3>
    <h3>Made by <strong><u>Radhika Gupta</u></strong></h3>
